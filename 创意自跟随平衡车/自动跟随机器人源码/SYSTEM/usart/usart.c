...
void USART1_IRQHandler(void)
{
		...
		if(USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)  //接收中断(接收到的数据必须是0x0d 0x0a结尾)
		{
			...
			if(Res==0x00)	Flag_Qian=0,Flag_Hou=0,Flag_Left=0,Flag_Right=0,LED=1;//////////////刹车
			else if(Res==0x01)	Flag_Qian=1,Flag_Hou=0,Flag_Left=0,Flag_Right=0,LED=0;//////////////前
			else if(Res==0x05)	Flag_Qian=0,Flag_Hou=1,Flag_Left=0,Flag_Right=0,LED=0;//////////////后
			else if(Res==0x02||Res==0x03||Res==0x04)	
														Flag_Qian=0,Flag_Hou=0,Flag_Left=0,Flag_Right=1,LED=0;  //左
			else if(Res==0x06||Res==0x07||Res==0x08)	    //右
